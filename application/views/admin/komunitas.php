                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<ul class="nav navbar-right panel_toolbox">
                                    <a href="<?php echo base_url();?>admin/tambahkomunitas" class="btn bg-deep-orange waves-effect">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
										...
										?>
                                            ...
                                            <td>
											<a href="<?php echo base_url();?>admin/detailkomunitas/<?php echo $row->id_pengguna; ?>" class="btn btn-warning btn-xs"><i class="material-icons">search</i><span>Detail</span></a>
											<a href="<?php echo base_url();?>admin/ambilkomunitas/<?php echo $row->id_pengguna; ?>" class="btn btn-info btn-xs"><i class="material-icons">create</i><span>Ubah</span></a>
											<a href="<?php echo base_url();?>admin/hapuskomunitas/<?php echo $row->id_pengguna; ?>" onclick="return confirm('anda yakin akan menghapus data ini');" class="btn btn-danger btn-xs"><i class="material-icons">delete</i><span>Hapus</span></a>
