							...
							<div class="row">
								...
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                        <div class="form-group">
									<div class="form-line disabled">                                                
										 <input type="text" class="form-control" value="<?php echo parse_time($row->waktu_donasi,'H:i');?> WIB" disabled />
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                        <div class="form-group">
									<div class="form-line disabled">                                                
										 <input type="text" class="form-control" value="<?php echo $row->status_donasi;?>" disabled />
                                            </div>
                                        </div>
                                    </div>
                                </div>
