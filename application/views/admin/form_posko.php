            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="<?php echo base_url();?>admin/simpanposko">
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
										...
										<input type="hidden" id="level" name="level" value="4" class="form-control" placeholder="Level">	
										<input type="hidden" id="foto" name="foto" value="group.png" class="form-control" placeholder="Foto"> 
