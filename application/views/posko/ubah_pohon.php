            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card no-shadow">
                        ...
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="<?php echo base_url();?>posko/editpohon" enctype="multipart/form-data">
								...
								<div class="row clearfix">
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
										...
										<input type="hidden" id="id_posko" name="id_posko" value="<?php echo $id_posko; ?>" class="form-control" placeholder="ID posko">										
                                        </div>
                                    </div>
                                </div>
