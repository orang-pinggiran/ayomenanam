				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-8">
                    <div class="card">
						...
						<hr>
						<p align="center">
						<a href="<?php echo base_url();?>posko/tambahdonasi/<?php echo $row->id_pohon; ?>" modal-size="modal-lg"  class="btn bg-light-green waves-effect modal-view"><span>DONASI</span></a>
                        </p>
						</div>
                    </div>
                </div>
