								...
								<div class="col-md-8 offset-md-6">
									...
									<?php
										...
										<div class="media">
													...
													<div class="media-body">
														<p align="justify">
														   <?php echo word_limiter($row->deskripsi_timeline,20) ?>...<a class="modal-view" modal-size="modal-lg" modal-title="Detail Timeline" href="<?php echo base_url();?>posko/detailtimeline/<?php echo $row->id_timeline; ?>"; >Lihat selengkapnya</a> 
														</p>	
														</div>
													</div>
												</div>
								...
								<div class="col-md-8 offset-md-6">
									...
									foreach ($cek2->result() as $row2) {
										...
										<img class="bulat" src="<?php echo base_url('adminBSB/images/'.$row2->foto); ?>" width="35" height="35" alt="User" />
													...
													<div class="media-body">
														<p align="justify">
														<?php echo word_limiter($row2->keterangan_event,20) ?>...<a class="modal-view" modal-size="modal-lg" modal-title="Detail Event" href="<?php echo base_url();?>posko/detailevent/<?php echo $row2->id_event; ?>"; >Lihat selengkapnya</a> 
														</p>	
														</div>
													</div>
												</div>
