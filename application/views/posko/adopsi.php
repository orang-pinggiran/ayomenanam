                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
										...
										?>
											...
											<a href="<?php echo base_url();?>posko/sertifikatadopsi/<?php echo $row->id_adopsi; ?>" modal-size="modal-lg" class="btn bg-light-green btn-xs modal-view"><i class="material-icons">class</i><span>Sertifikat</span></a>
