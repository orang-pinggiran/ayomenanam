					...
					<div class="header">
                            <div class="row clearfix">
                                ...
                                <div class="col-xs-12 col-sm-6 align-right">
                                    <a href="<?php echo base_url();?>posko/tambahkategori" class="btn bg-deep-orange waves-effect">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
										...
										?>
                                            ...
                                            <td>
											<a href="<?php echo base_url();?>posko/ambilkategori/<?php echo $row->id_kategori; ?>" class="btn btn-info btn-xs"><i class="material-icons">create</i><span>Ubah</span></a>
											<a href="<?php echo base_url();?>posko/hapuskategori/<?php echo $row->id_kategori; ?>" onclick="return confirm('anda yakin akan menghapus data ini');" class="btn btn-danger btn-xs"><i class="material-icons">delete</i><span>Hapus</span></a>
