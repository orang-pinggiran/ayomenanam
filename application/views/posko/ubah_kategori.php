            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="<?php echo base_url();?>admin/editkategori">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="nama_kategori" name="nama_kategori" value="<?php echo $nama_kategori; ?>" class="form-control" placeholder="Nama kategori">
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row clearfix">
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
										<input type="hidden" id="id_kategori" name="id_kategori" value="<?php echo $id_kategori; ?>" class="form-control" placeholder="ID kategori">										
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        ...
                                        <a href="<?php echo base_url();?>admin/kategori" class="btn bg-orange m-t-15 waves-effect">Kembali </button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
