        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>pengguna">AYO MENANAM</a>
                </div>
					...
					<?php 
                        ...
                        <div class="btn-group user-helper-dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="<?php echo base_url();?>pengguna/profil/<?php echo $row->id_pengguna; ?>"><i class="material-icons">person</i>Profil</a></li>
                                <li><a href="<?php echo base_url('pengguna/logout'); ?>"><i class="material-icons">input</i>Logout</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="list">
					   ...
					   <li>
                            <a href="javascript:void(0);" class="menu-toggle">
							 ...
							 <ul class="ml-menu">
                                <li>
                                    <a href="<?php echo base_url();?>pengguna/donasi">Tambah Donasi</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>pengguna/manajemen_donasi">Manajemen Donasi</a>
                                </li>
                            </ul>
                        </li>       
						
						<li>
                            <a href="<?php echo base_url();?>pengguna/adopsi">
						...
						<li>
                            <a href="<?php echo base_url();?>pengguna/timeline">
						...
						<li>
                            <a href="<?php echo base_url();?>pengguna/map">
