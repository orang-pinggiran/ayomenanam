                                    ...
                                    <tbody>
										...
										?>
											...
											if ($row->status_adopsi=="Disetujui") {
												?>
											<td>
											<a href="<?php echo base_url();?>pengguna/detailadopsi/<?php echo $row->id_adopsi; ?>" modal-size="modal-lg" class="btn btn-warning btn-xs modal-view"><i class="material-icons">search</i><span>Detail</span></a>
											<a href="<?php echo base_url();?>pengguna/sertifikatadopsi/<?php echo $row->id_adopsi; ?>" modal-size="modal-lg" class="btn bg-light-green btn-xs modal-view"><i class="material-icons">class</i><span>Sertifikat</span></a>
