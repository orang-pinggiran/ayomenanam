                 ...
                 <!-- Horizontal Layout -->
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" method="POST" action="<?php echo base_url();?>pengguna/simpandonasi">
						        ...
						        <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        ...
                                        <a href="<?php echo base_url();?>pengguna/donasi" class="btn bg-orange m-t-15 waves-effect">Kembali </button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
