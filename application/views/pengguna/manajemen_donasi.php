                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
										...
										?>
											...
											?>
											<td>
											<a href="<?php echo base_url();?>pengguna/detaildonasi/<?php echo $row->id_donasi; ?>" modal-size="modal-lg" class="btn btn-warning btn-xs modal-view"><i class="material-icons">search</i><span>Detail</span></a>
											<a href="<?php echo base_url();?>pengguna/ambildonasi/<?php echo $row->id_donasi; ?>" modal-size="modal-lg"  class="btn btn-info btn-xs modal-view"><i class="material-icons">create</i><span>Ubah</span></a>
											<a href="<?php echo base_url();?>pengguna/hapusdonasi/<?php echo $row->id_donasi; ?>" onclick="return confirm('anda yakin akan menghapus data ini');" class="btn btn-danger btn-xs"><i class="material-icons">delete</i><span>Hapus</span></a>
