                ...
                <hr>
					...
					<div class="header">
					 ...
					 <div class="btn-ground">
                        <a href="<?php echo base_url();?>komunitas/adopsipohon/<?php echo $id_event; ?>" class="btn btn-primary"><span class="glyphicon glyphicon-shopping-cart"></span> Adopsi Pohon</a>
                        </div>
