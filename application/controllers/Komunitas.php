...
class Komunitas extends CI_Controller {
	...
	public function index()
	{
		...
		$isi['content'] 	= 'komunitas/dashboard';
	...
	public function profil()
	{
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/ubah_pengguna';
		...
		$this->load->view('komunitas/ubah_pengguna',$isi);
		}
    ...
    if($foto->num_rows()>0){
      ...
      if(file_exists($lok=FCPATH.'/adminBSB/images/'.$name)){
		...
		redirect('komunitas/profil/'.$id_pengguna);
		}
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/ubah_komunitas';
		...
		$this->load->view('komunitas/ubah_komunitas',$isi);
		}
	...
	public function detailtimeline()
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/detail_timeline';
		...
		$this->load->view('komunitas/detail_timeline',$isi);
		}
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/ubah_timeline';
		...
		$this->load->view('komunitas/ubah_timeline',$isi);
		}
	...
	public function detailevent()
	{
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/detail_event';
		...
		public function adopsipohon()
	{
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/tambah_adopsi';
		...
		redirect(site_url('komunitas/adopsipohon'));
		}
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/timeline';
		$isi['data'] 		= $this->m_timeline->timeline();
		$this->load->view('komunitas/template',$isi);
		}
		...
		redirect(site_url('komunitas/adopsi'));
		}
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/detail_adopsi';
		...
		$this->load->view('komunitas/detail_adopsi', $isi);
		}
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/ubah_adopsi';
		...
		$this->load->view('komunitas/ubah_adopsi',$isi);
		}
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/sertifikat_adopsi';
		...
		$this->load->view('komunitas/sertifikat_adopsi',$isi);
		}
		...
		$halaman = $this->load->view('komunitas/sertifikatadopsi', $isi, TRUE);		
		//echo $halaman;
		//exit();
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/form_donasi';
		...
		$this->load->view('komunitas/form_donasi',$isi);
		}
		...
		redirect(site_url('komunitas/donasi'));
		}
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/manajemen_donasi';
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/detail_donasi';
		...
		$this->load->view('komunitas/detail_donasi',$isi);
		}
		...
		$this->m_squrity->getsqurity();
		$isi['email'] = $this->session->userdata('email');
		$isi['content'] 	= 'komunitas/ubah_donasi';
		...
		if($cek->num_rows()>0){
			...
			$this->session->set_flashdata('info','<div class="alert alert-success">Data donasi berhasil diubah</div>');		
			  ...
			  redirect('komunitas/manajemen_donasi');
		}
		...
		redirect(site_url('komunitas/manajemen_donasi'));
